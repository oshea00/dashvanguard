...
df_fund_facts = pd.read_csv("data/fundfacts.csv")
df_price_perf = pd.read_csv("data/priceperf.csv")
df_current_prices = pd.read_csv("data/currprice.csv")
df_hist_prices = pd.read_csv("data/histprice.csv")
df_avg_returns = pd.read_csv("data/avgreturns.csv")
df_after_tax = pd.read_csv("data/aftertax.csv")
df_recent_returns = pd.read_csv("data/recentreturns.csv")
df_equity_char = pd.read_csv("data/equitychar.csv")
df_equity_diver = pd.read_csv("data/equitydiver.csv")
df_expenses = pd.read_csv("data/expenses.csv")
df_minimums = pd.read_csv("data/minimums.csv")
df_dividend = pd.read_csv("data/dividens.csv")
df_realized = pd.read_csv("data/realized.csv")
df_unrealized = pd.read_csv("data/unrealized.csv")
...
def get_logo():
    logo = html.Div([
        ...
        html.Div([
             html.Img(src='/static/FTLogo.png', height='60', width='60',style={'vertical-align':'middle'}),
             html.Span("Future Trends Consulting",className='header-title')
